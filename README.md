...
**AI / LLM**
- OpenAI Agents SDK (Agent, Runner, SQLiteSession)
- OpenAI Responses API
- GPT-4o / GPT-4.1

**Tools (Hosted)**
- WebSearchTool — 웹 검색
- FileSearchTool — 목표 문서 검색
- ImageGenerationTool — 비전 보드 / 동기부여 포스터 생성

**Storage**
- OpenAI Vector Store — 목표 문서 인덱싱 및 검색
- SQLite — 대화 세션 메모리 (coach_memory.db)

**Library**
- openai — Vector Store 파일 업로드
